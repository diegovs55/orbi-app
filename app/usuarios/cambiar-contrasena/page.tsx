...
import { getCustomerByAuthUserId, saveCustomerSession } from "@/lib/customers";
...
export default function UsuariosCambiarContrasenaPage() {
        ...
        <main className="mt-16 flex flex-1 flex-col justify-center gap-12 lg:flex-row lg:items-center lg:gap-20">
          <section className="max-w-xl space-y-6 lg:shrink-0">
            ...
            <p className="max-w-lg text-base leading-7 text-orbi-muted sm:text-lg">
              El equipo Orbi te entregó una contraseña temporal. Por seguridad debes cambiarla antes de acceder a tu cuenta. Esta contraseña solo la conocerás tú.
            </p>
          </section>
